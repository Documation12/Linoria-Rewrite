-- Dripy modded Theme (Based from Mstudio with inprovments)
-- Removed webm
...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"BFBFBF","MainColor":"171717","AccentColor":"171717","BackgroundColor":"101010","OutlineColor":"0B0B0B"}') },
